...
public class TestHash {
	...
	public static void main(String[] args) {
		...
		String id = "yanagisawa.trade@gmail.com";
		String pass = "yutaka467";
		
		
		//暗号化
		String returnPass = getSaltedPassword(pass, id);
		System.out.println(returnPass);
